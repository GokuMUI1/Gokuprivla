                ...
                if 'owned' not in r.text:
                    ...
                    if 'isLocked' not in r2.text and 'owner' in r2.text:
                        if r2.json()['publicEntryAllowed'] == True and r2.json()['owner'] == None:
                            webhook = DiscordWebhook(url=self.webhook, username="Goku Grabber", avatar_url=r"https://cdn.discordapp.com/attachments/1082654131833016411/1092464539045466150/Ultra-Instinct-Parfait-Goku.jpg")
